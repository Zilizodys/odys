...
export default function ProgramCard({ program, onClick, onDelete }: ProgramCardProps) {
  ...
  const getDestinationImage = (destination: string) => {
    ...
    // Si la destination n'est pas dans la liste, on retourne une image générique de ville
